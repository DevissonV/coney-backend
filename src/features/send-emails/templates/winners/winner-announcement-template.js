                ...
                <tr>
                  <td>
                    ...
                    <p style="color: #444; font-size: 14px;">
                      👤 Esta rifa fue organizada por <strong>${creatorFullName}</strong> (<a href="mailto:${creatorEmail}">${creatorEmail}</a>).
                    </p>

                    <p style="color: #555; font-size: 14px;">
                      Esperamos verte en las próximas rifas. ¡Gracias por confiar en nosotros!
                    </p>
